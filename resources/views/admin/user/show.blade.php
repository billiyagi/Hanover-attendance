        ...
        <div class="h-full w-full pb-6 bg-base-300">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="form-control w-full undefined"><label class="label"><span
                    ...
                    <div class="avatar">
                        <div class="mask mask-circle w-20 h-20"><img
                ...
                <div class="form-control w-full undefined"><label class="label"><span
                        ...
                        type="email" placeholder="" class="input  input-bordered w-full " value="{{ $user->email }}"
                        readonly></div>
                <div class="form-control w-full undefined"><label class="label"><span
                            class="label-text text-base-content undefined">Username</span></label><input name="username"
                        type="text" placeholder="" class="input  input-bordered w-full " value="{{ $user->username }}"
                        readonly>
                    <label class="label">
                        @error('username')
                ...
                <div class="form-control w-full undefined"><label class="label"><span
                    ...
                    <input value="{{ ucfirst($user->role) }}" name="role_id" type="text" placeholder=""
                        class="input  input-bordered w-full " readonly>
                </div>
            </div>
            <div class="mt-16"><a href="/" class="btn btn-default float-right">Kembali</a></div>
        </div>
    </div>
